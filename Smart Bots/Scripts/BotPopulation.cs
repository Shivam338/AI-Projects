...
public class BotPopulation : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < PopulationSize; i++)
        {
            ...
            bot.GetComponent<BotBrain>().Init();  // Gives Bots a Random Value for the single gene
            Population.Add(bot);
        }
    }
    ...
    GameObject Breed(GameObject Parent1, GameObject Parent2)
    {
        ...
        BotBrain B = offspring.GetComponent<BotBrain>();
        ...
        else
        {
            ...
            B.bot_DNA.OffSpringGen(Parent1.GetComponent<BotBrain>().bot_DNA, Parent2.GetComponent<BotBrain>().bot_DNA);
        }
        return offspring;
    }
    ...
    void BreedPopulation()
    {
        ...
        List<GameObject> sortedList = Population.OrderBy(x => x.GetComponent<BotBrain>().LifeSpan + x.GetComponent<BotBrain>().WalkTime).ToList();
